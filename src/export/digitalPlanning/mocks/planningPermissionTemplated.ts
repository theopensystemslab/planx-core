...
export const mockPPTSession: Session = {
  id: "7ae499ac-4f0e-482c-bb1e-f8a64eacca2e",
  flow: {
    id: "6c2a19f0-0291-4acb-b29a-277eceaf76a4",
    name: "Apply for planning permission templated",
  ...
  submittedAt: "2025-10-29T09:15:29.820312+00:00",
  data: {
    id: "6c2a19f0-0291-4acb-b29a-277eceaf76a4",
    passport: {
      data: {
        ...
        _address: {
          ...
          single_line_address:
            "13, WHARMLANDS ROAD, SCOTSWOOD, NEWCASTLE UPON TYNE, NE15 7UB",
        },
        "user.role": ["applicant"],
        usedFOIYNPP: ["false"],
        _constraints: [
        ...
        "property.ward": ["Benwell & Scotswood"],
        "proposal.site": {
          type: "Feature",
          geometry: {
            type: "MultiPolygon",
        ...
        "proposal.description":
          "Erection of first floor extension above garage to side and single storey full width extension to rear",
        "proposal.extend.area": 5,
        "proposal.projectType": ["alter", "extend"],
        "application.CIL.result": ["notLiable"],
        "property.boundary.area": 211.7,
        "property.heritageAsset": ["no"],
        "property.trees.present": ["false"],
        ...
        "applicant.ownership.interest": ["owner.sole"],
        "application.CIL.newDwellings": ["false"],
        "application.fee.category.six": ["true"],
        "eligibilityCheck.householder": ["true"],
        "proposal.changeNumberOfHomes": ["noChange"],
        "application.preAppAdvice.form": ["No"],
        "proposal.materials.three.type": "roof",
        "application.CIL.s73Application": ["false"],
        "proposal.floorArea.new.100Plus": ["false"],
        "applicant.ownership.certificate": ["a"],
        "property.boundary.area.hectares": 0.02117,
        "property.localAuthorityDistrict": ["Newcastle upon Tyne"],
        "property.localPlanningAuthority": ["Newcastle upon Tyne LPA"],
        ...
        "proposal.siteArea.oneHectareOrMore": ["false"],
        "application.fee.category.six.number": 1,
        "proposal.residentialAnnexeExtension": ["false"],
        "application.CIL.declaration.accurate": ["true"],
        "application.CIL.floorAreaHundredPlus": ["false"],
        ...
        "property.ownership.agriculturalTenants": ["false"],
        "application.declaration.connection.form": ["No connections"],
        "application.fee.reduction.parishCouncil": ["false"],
        "proposal.changeNonResidentialFloorspace": ["false"],
        "application.CIL.existingPermissionPrecedingCIL": ["false"],
        "applicant.ownership.certificate.declaration.accurate": ["true"],
      },
    },
    breadcrumbs: {
      "0anwI4KNHH": {
      ...
      JLH4vAGZvv: {
        auto: true,
        answers: ["6zhciAGZvv", "6zhciAGZvv", "6zhciAGZvv"],
      },
      JU98xBB58o: {
        auto: false,
        answers: ["heTwiBB58o"],
